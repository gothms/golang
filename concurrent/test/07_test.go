...
/*
BenchmarkCondRunner-8               1802            645758 ns/op	// 锁
BenchmarkCondRunner-8              11134            107294 ns/op	// 原子操作 Broadcast
BenchmarkCondRunner-8               3232            312592 ns/op	// 原子操作 Signal
*/

func BenchmarkCondRunner(b *testing.B) {
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
// TestCondCheck 测试 func (c *copyChecker) check()，没成功
...
type Cond struct {
	...
	L sync.Locker // 当观察或者修改等待条件的时候需要加锁
