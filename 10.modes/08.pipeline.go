...
原文：https://time.geekbang.com/column/article/330463?utm_source=pc_cp&utm_term=pc_interstitial_1346
	...
	1.Pipeline：一种把各种命令拼接起来完成一个更强功能的技术方法
		1)现在的
			流式处理
			函数式编程
			应用网关对微服务进行简单的API编排
	...
	2.07 节的 test 4
	3.若要写一个 泛型的 Pipeline 框架并不容易，可以使用 Go Generation 实现
		但 Go 语言最具特色的 Go Routine 和 Channel 完全可以用来构造这种编程
			参考：Go Concurrency Patterns: Pipelines and cancellation
			https://blog.golang.org/pipelines
	5.Fan In/Fan Out：一对多/多对一
		**看原文的代码**
